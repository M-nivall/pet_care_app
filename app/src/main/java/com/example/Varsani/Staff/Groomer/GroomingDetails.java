package com.example.Varsani.Staff.Groomer;
...
public class GroomingDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grooming_details);
        ...
        chk3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chk3.isChecked()) {
                    ...
                    materials.append("Nail Clippers");
                    edt_materials.setText(materials);
                }
            }
        });
    ...
    public void getAlert(View v){
        ...
        builder.setTitle("Request Materials From Inventory");
