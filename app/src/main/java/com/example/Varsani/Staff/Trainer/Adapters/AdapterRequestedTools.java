...
import com.example.Varsani.Staff.Trainer.ReturnRequestedTools;

import java.util.List;

public class AdapterRequestedTools extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    }
    ...
    public AdapterRequestedTools(Context context, List<RequestModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterRequestedTools.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterRequestedTools.OriginalViewHolder) {
            final AdapterRequestedTools.OriginalViewHolder view = (AdapterRequestedTools.OriginalViewHolder) holder;
            ...
            if (o.getRequestStatus().equals("Approved")){

                view.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        Intent in=new Intent(ctx, ReturnRequestedTools.class);
