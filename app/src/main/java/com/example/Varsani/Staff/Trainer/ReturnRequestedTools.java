...
import static com.example.Varsani.utils.Urls.URL_RETURN_MATERIALS;
...
public class ReturnRequestedTools extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_requested_tools);
    ...
    public void approve(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_RETURN_MATERIALS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")){
                                ...
                                Toast toast= Toast.makeText(ReturnRequestedTools.this, msg, Toast.LENGTH_SHORT);
                            ...
                            e.printStackTrace();
                            Toast toast= Toast.makeText(ReturnRequestedTools.this, e.toString(), Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.TOP,0,250);
                            toast.show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast toast= Toast.makeText(ReturnRequestedTools.this, error.toString(), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.TOP,0,250);
                toast.show();
            }
        }){
    ...
    public void alertApprove(){
        ...
        alertDialog.setMessage("You are About to Return this tools");
